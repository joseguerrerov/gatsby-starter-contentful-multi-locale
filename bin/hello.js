...
Thanks for giving the ${chalk.bold(pkg.name)} a try. 🎉
...
${chalk.yellow.bold('yarn run setup')} automates the following steps for you:
  - creates a .env file with you contentful spaceId and Access Token
...
(https://github.com/joseguerrerov/gatsby-starter-contentful-multi-locale)
`);
